...
export default class extends Component {
    ...
    deleteRecord=(event) => {
        ...
        CharitiesRequests.deleteByID(this.state.idDelete).then((response) => {
            this.getAllRecords();
        });
    }
                            ...
                            <tr key={index}>
                                ...
                                <td className="text-center">
                                    ...
                                    <Link className="btn btn-warning btn-sm mr-2"
                                        to={`${RouteConst.backEnd.charities.index.path}/${item.id}/edit`}>
                    ...
                    <div className="card-header">
                        <div className="float-left">
                            <p className="mb-0 mt-1">
                                <i className="fas fa-table"></i> List Charities
                            </p>
                        </div>
                        <div className="float-right">
                            <Link to={RouteConst.backEnd.charities.create.path}>
